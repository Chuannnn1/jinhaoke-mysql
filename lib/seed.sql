...
INSERT INTO "order" (order_id, order_date, status, customer_phone) VALUES
  ('A202605250001', '2026-05-25', '已完成', '0912-345-678');
INSERT INTO "order" (order_id, order_date, status, customer_phone) VALUES
  ('A202605250002', '2026-05-25', '待製作', '0933-456-789');
INSERT INTO "order" (order_id, order_date, status, customer_phone) VALUES
  ('A202605250003', '2026-05-25', '製作中', '0944-567-890');

-- ============================================================
-- 顧客訂單明細（order_item）— unit_price 為下單時的單價快照
-- ============================================================
INSERT INTO order_item VALUES
  ('A202605250001', 1,  2, 130);  -- 王小明：大比目魚排便當 x2
INSERT INTO order_item VALUES
  ('A202605250001', 9,  1, 110);  -- 王小明：沙茶牛肉燴飯 x1
INSERT INTO order_item VALUES
  ('A202605250002', 2,  3, 130);  -- 陳小美：酥炸豬排便當 x3
INSERT INTO order_item VALUES
  ('A202605250002', 22, 2, 20);   -- 陳小美：白飯 x2
INSERT INTO order_item VALUES
  ('A202605250003', 5,  1, 100);  -- 張小華：酥炸排骨便當 x1
